...
export default function ContactPage() {
  ...
  // Media configuration - using Cloudinary optimized URLs
  const mediaItems = [
    { 
      src: 'https://res.cloudinary.com/di3tlhcnj/video/upload/q_auto,f_auto,c_fill,g_auto,w_640,h_360/v1760771296/cube3_tabrsi.mp4', 
      poster: 'https://res.cloudinary.com/di3tlhcnj/video/upload/v1760771296/cube3_tabrsi.jpg',
      type: 'video' as const, 
      title: 'Clock' 
    },
    { 
      src: 'https://res.cloudinary.com/di3tlhcnj/video/upload/q_auto,f_auto,c_fill,g_auto,w_640,h_360/v1760771065/cube0_bgwz9n.mp4', 
      poster: 'https://res.cloudinary.com/di3tlhcnj/video/upload/v1760771065/cube0_bgwz9n.jpg',
      type: 'video' as const, 
      title: '3x3 with Feet' 
    },
    { src: '/Media/cubepic2.jpg', type: 'image' as const, title: "SSN Cube Open '25 "},
    { 
      src: 'https://res.cloudinary.com/di3tlhcnj/video/upload/q_auto,f_auto,c_fill,g_auto,w_640,h_360/v1760771088/ohmcc2_zn3uri.mp4', 
      poster: 'https://res.cloudinary.com/di3tlhcnj/video/upload/v1760771088/ohmcc2_zn3uri.jpg',
      type: 'video' as const, 
      title: "3x3 One-Handed " 
    },
    { src: '/Media/cubepic1.jpg', type: 'image' as const, title: "Kumaraguru Cube Open '24" },
    { 
      src: 'https://res.cloudinary.com/di3tlhcnj/video/upload/q_auto,f_auto,c_fill,g_auto,w_640,h_360/v1760772133/sq1mcc_1_naipzn.mp4', 
      poster: 'https://res.cloudinary.com/di3tlhcnj/video/upload/v1760772133/sq1mcc_1_naipzn.jpg',
      type: 'video' as const, 
      title: "SQ1 " 
    },
    { 
      src: 'https://res.cloudinary.com/di3tlhcnj/video/upload/q_auto,f_auto,c_fill,g_auto,w_640,h_360/v1760773491/skewbmcc_1_ukhlek.mp4', 
      poster: 'https://res.cloudinary.com/di3tlhcnj/video/upload/v1760773491/skewbmcc_1_ukhlek.jpg',
      type: 'video' as const, 
      title: 'Skewb ' 
    },
              ...
              {/* Masonry Grid */}
                ...
                {shuffledMedia.map((item, idx) => (
                  <div
                    ...
                    onClick={() => item.type !== 'wca' && setLightbox({ open: true, type: item.type, src: item.src, poster: item.poster, caption: item.title })}
                  >
                    {item.type === 'video' ? (
                      <video
                        src={item.src}
